        ...
        <section>
            <div class="container u-margin-big">
                <div class="row p-4" style="background-color: #A5A5A5; color:white">
                    <div class="col p-4">     
                        <h2 class="display-5 fw-bold" style="display:inline-block"> Event Report </h2>&nbsp;<span style="display:inline-block"></span>
                     </div>
                </div>
                <div class="row u-margin-big">
                    <div>
                        <table id='example' class='display dataTable table table-striped'>
                            <thead>
                                <tr>
                                    <th>Event Title</th>
